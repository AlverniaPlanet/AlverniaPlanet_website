...
// Stary adres /pt/attractions/exhibition, kanoniczny jest teraz /pt/harry-potter-the-exhibition.
// Statyczny eksport (output: "export") → przekierowanie po stronie klienta.
const TARGET_PATH = "/pt/harry-potter-the-exhibition";
...
export default function LegacyPtExhibitionRedirect() {
