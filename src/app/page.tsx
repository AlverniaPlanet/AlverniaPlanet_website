...
const HOME_COPY: Record<Locale, HomeCopy> = {
  pl: {
    ...
    news: {
      title: "Aktualności",
      intro:
        "Najważniejsze nowości z Alvernia Planet, nad którymi pracujemy właśnie teraz.",
      items: [
        {
          badge: "Od stycznia",
        ...
        },
        {
          ...
          title: "Otwieramy największe kino 360° w tej części świata",
          description:
        ...
        {
          badge: "Media",
          title: "Powstał o nas popularnonaukowy artykuł",
          description:
            "O Alvernia Planet ukazał się popularnonaukowy materiał, który pokazuje nas jako futurystyczną atrakcję łączącą architekturę, edukację i filmowy rozmach. To dobre szybkie wprowadzenie dla osób, które chcą zrozumieć, skąd bierze się wyjątkowość tego miejsca.",
    ...
    news: {
      ...
      items: [
        ...
        },
        {
          ...
          title: "We are opening the largest 360° cinema in this part of the world",
          description:
        ...
        {
          badge: "Media",
          title: "A popular-science article has been published about us",
          description:
            "Alvernia Planet has been featured in a popular-science article presenting the venue as a futuristic destination where architecture, education, and cinematic ambition come together in one place.",
  ...
  pt: {
    ...
    news: {
      ...
      items: [
        ...
        {
          badge: "Abre em abril",
          title: "Vamos abrir o maior cinema 360° desta parte do mundo",
          description:
        ...
        {
          badge: "Media",
          title: "Foi publicado um artigo de divulgação científica sobre nós",
          description:
            "A Alvernia Planet foi apresentada num artigo de divulgação científica como uma atração futurista onde arquitetura, educação e universo cinematográfico se encontram num só lugar.",
          cta: "Ler o artigo",
          href: "https://www.klubpodroznikow.com/alvernia-planet-futurystyczna-atrakcja-turystyczna-jak-z-kosmosu/",
          external: true,
        },
...
const NewsSectionBlock = memo(function NewsSectionBlock({
  news,
}: {
  news: NewsSection;
}) {
